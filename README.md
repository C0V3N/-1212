...
[![inlang status badge](https://inlang.com/badge?url=github.com/C0V3N/-1212)](https://inlang.com/editor/github.com/C0V3N/-1212?ref=badge)
</div>

Improve existing languages or add new ones by manually editing the JSON files located in `/hiddify_extension/translations` or by using the [Inlang online editor](https://inlang.com/editor/github.com/C0V3N/-1212).
